...
public sealed partial class DecodePage : Page
{
    ...
    public string DecodeBitmap(Bitmap bitmap)
    {
        ...
        if (decoded == null)
        {
            var noCode = "No barcode found. Please try again.";
            stateManager(false);
            return noCode;
        ...
        else
        {
            ...
            BarcodeType.Message = decoded.BarcodeFormat.ToString();
            return result;
        }
    }
    ...
    private async void DecodeFromSnippingTool(object sender, RoutedEventArgs e)
    {
        ...
        {
            TxtActivityLog.Text = "No Snipping Tool screenshot detected.";
            BarcodeViewer.Source = null;
        }
    }
    ...
    private async void CapturePhoto_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            if (Directory.Exists(barcodeFolder.Path))
            {
                ...
                var file = await barcodeFolder.CreateFileAsync("barcode.jpg", CreationCollisionOption.ReplaceExisting);
                ...
                TxtActivityLog.Text = "Photo saved to: " + file.Path;
